...
(function () {
  ...
  var PROCESS_STEPS = [
    ...
    { file: "assets/case-process-canister-diecut-create.png", source: "Canister die cut concept, CREATE", tag: "Variant", intent: "Wordmark choice", title: "Die Cut Test: CREATE", desc: "A third word, \"CREATE,\" was tested in the same finished canister layout, completing a three way comparison of which die cut word carried the ad best.", changed: "Re ran the same finished ad layout a third time with \"CREATE\" as the cut out word.", connects: "Closed out the wordmark comparison and left the canister concept fully resolved, right before the decision to leave the canister behind entirely." },
    { file: "assets/case-process-canister-studio-options.png", source: "Canister studio options sheet", tag: "Variant", intent: "Product photography review", title: "Canister Studio Options", desc: "A contact sheet of four product style shots (lying down, upright, torn open, and angled against black) reviewed how the finished canister photographed from different angles, independent of any layout.", changed: "Stepped back from ad layouts to review the object itself as a piece of product photography.", connects: "This kind of object only review is the same instinct that, applied to the reel instead of the canister, produced the final ad's hero shot." },
    { file: "assets/case-process-canister-altfinal-01.png", source: "Canister alternate final 01", tag: "Alternate", intent: "Parallel layout direction", title: "Canister Alternate: Editorial Layout", desc: "One full alternate ad was built around the canister lying on its side, branded \"35mm color print film\" with a \"Design with Purpose\" tagline, in a more editorial, magazine style square layout.", changed: "Tried a completely different layout grammar (horizontal hero object, tagline strip, corner globe icon) around the same canister object.", connects: "Kept as a reference point for layout variety even after the canister itself was set aside." },
