...
(function () {
  ...
  var PROCESS_STEPS = [
    ...
    { file: "assets/case-process-lego-reel.png", source: "LEGO reel concept", tag: "Material Test", intent: "Built, not photographed", title: "Building the Reel from LEGO", desc: "The reel was rebuilt as a LEGO model — no tool compartments yet, just the brick-built object itself — under \"Build the impossible,\" testing a constructed, toy-like material instead of straight photography.", changed: "Introduced LEGO bricks as the reel's material for the first time, before any compartments or tools were added.", connects: "This single decision — building the hero object instead of photographing a real one — is what eventually let the final ad cut transparent windows into the reel and fill them with real tools." },
